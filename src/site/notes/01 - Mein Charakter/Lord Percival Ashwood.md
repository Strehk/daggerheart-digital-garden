---
{"dg-publish":true,"permalink":"/01-mein-charakter/lord-percival-ashwood/","tags":["pc","eigener-charakter","ashwood","seraph","butler"],"dg-note-properties":{"type":"pc","class":"Seraph","subclass":null,"ancestry":"Mixed (Faerie + Firbolg/Zwerg, reflavored als Schnee-Adler-Aëthon)","community":"Highborne","domains":["Splendor","Valor"],"deity":"Nira","level":1,"hope":2,"fear":0,"status":"active","tags":["pc","eigener-charakter","ashwood","seraph","butler"]}}
---


# Lord Percival "Percy" Ashwood

![Percy Portrait.png](/img/user/01%20-%20Mein%20Charakter/Bilder/Percy%20Portrait.png)

> *„Manieren dominieren!"*
> Ein über zwei Meter großer Schnee-Adler im makellosen Frack. Majordomus aus [[04 - Welt/Orte/Schauplätze/Sternenfall\|Sternenfall]], frisch ernannter Seraph der [[04 - Welt/Pantheon & Religion/Nira\|Nira]] — und auf Bildungsurlaub, der keiner ist.

## Konzept in einem Atemzug
Percy ist ein hingebungsvoller Butler, der durch die Reinheit seiner Fürsorge **unbewusst** zu einem Seraph der [[04 - Welt/Pantheon & Religion/Nira\|Nira]] wurde. Seine Herrin [[03 - NPCs/Lady Elara Vance\|Lady Elara Vance]] ist verschwunden — er vertuscht das Chaos mit höfischem Protokoll und macht sich auf die Suche.
...
- Wie aus einem Gemälde aus [[04 - Welt/Orte/Schauplätze/Sternenfall\|Sternenfall]] direkt herausgetreten.
...
- **Subclass:** *(noch zu wählen)*
- **Domains:** **Splendor**, **Valor**.
- **Berufung:** durch [[04 - Welt/Pantheon & Religion/Nira\|Nira]] — Aspekte **Frieden** und **Geborgenheit**. Percy hat keinen Tempel je von innen gesehen. Seine Magie äußert sich als **sanfte goldene Wärme**, die den Raum erfüllt, sobald er ihn betritt.

## Ancestry & Community
- **Ancestry:** **Mixed** — Faerie (Flügel) + Firbolg/Zwerg (stoische Widerstandskraft). **Reflavored als Schnee-Adler-Aëthon** der [[03 - NPCs/Familie Ashwood\|Familie Ashwood]].
- **Community:** [[Highborne\|Highborne]] — tief in die High Society von [[04 - Welt/Orte/Siedlungen/Vestangen\|Vestangen]] und die Strukturen der [[04 - Welt/Fraktionen/Familie Rith'kar\|Rith'kar]] verwoben.

> [!info] Klärungsbedarf
> Mixed Ancestry: zweite Hälfte (Firbolg vs. Zwerg) noch zu entscheiden — siehe [[01 - Mein Charakter/Charakter-Bau/Ancestry-Auswahl\|Ancestry-Auswahl]].
...
- [[08 - Mechaniken/Spieler-Prinzipien\|Spieler-Prinzipien]] — *Nehmt den Winter an* trifft Percy nur halb: er hat sich nicht arrangiert, sondern den Winter zur Regel des Anstands gemacht.
- [[08 - Mechaniken/Gunst der Rith'kar\|Gunst der Rith'kar]] — Percy startet als loyaler Hofangehöriger; Startwert vermutlich **leicht positiv**.
