---
{"dg-publish":true,"permalink":"/04-welt/pantheon-and-religion/zyllan/","tags":["pantheon","gottheit"],"dg-note-properties":{"type":"lore","tags":["pantheon","gottheit"],"deity_aspect":"zwielicht"}}
---


# Zyllan — das Zwielicht

> Die dritte Gottheit. Hält **Talos** und **Nira** davon ab, sich je zu vereinen — bösartig oder bewahrend, je nachdem, wen man fragt.

## Sphären
- **Verschoben:** List, Zwietracht, Krankheit, Zweifel
- **Verbindend:** Liebe, Ambiguität, Beziehungen

## Priester:innen
**Suchende** — die Vagen, die Fragenden, die in Grauzonen denken.
